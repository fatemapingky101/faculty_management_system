    ...
    <main>
      ...
      <section class="content">
        <aside class="sidebar">
          <ul>
            <li>
              <a href="engineering.html">Message from the Dean</a>
            </li>
            <li>
              <a href="about.html">About the Faculty</a>
            </li>
            <li>
              <a href="vision.html">Vision & Mission</a>
            </li>
            <li>
              <a href="functions.html">Functions Of The Faculty</a>
            </li>
            <li>
              <a href="previousdean.html">Previous Deans</a>
            </li>
          </ul>
        </aside>
      ...
      <section class="departments">
        ...
        <div class="department-list">
          ...
          <div class="department-item">
            <img
              src="/images/Kaptai_Lake_(19833365911).jpg"
        ...
        -->
          <div class="faculty-grid">
            <div class="faculty-card">
              ...
              <a href="engineering.html" class="view-website">View...</a>
            </div>

            <div class="faculty-card">
              <img src="images/science.jpg" alt="Faculty of Arts" />
              <h2>Faculty of Science</h2>
              <a href="science.html" class="view-website">View...</a>
            </div>
