        ...
        -->
          <div class="faculty-grid">
            <div class="faculty-card">
              <img src="images/engneering.jpg" alt="Management" />
              <h2>Management</h2>
              <a href="management.html" class="view-website">View...</a>
            </div>

            <div class="faculty-card">
              <img src="images/science.jpg" alt="Faculty of Arts" />
              <h2>Marketing</h2>
              <a href="marketing.html" class="view-website">View...</a>
            </div>
            ...
            <div class="faculty-card">
              ...
              />
              <h2>Finance</h2>
              <a href="finance.html" class="view-website">View...</a>
            </div>
          </div>
        </div>
      </section>
