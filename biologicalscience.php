        ...
        -->
          <div class="faculty-grid">
            <div class="faculty-card">
              <img src="images/engneering.jpg" alt="Botany" />
              <h2>Botany</h2>
              <a href="botany.html" class="view-website">View...</a>
            </div>

            <div class="faculty-card">
              <img src="images/science.jpg" alt="zoology" />
              <h2>Zoology</h2>
              <a href="zoology.html" class="view-website">View...</a>
            </div>
            ...
            <div class="faculty-card">
              ...
              />
              <h2>Public Health</h2>
              <a href="publichealth.html" class="view-website">View...</a>
            </div>
          </div>
        </div>
      </section>
